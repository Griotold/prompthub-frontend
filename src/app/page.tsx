      ...
      <main className="relative">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            <div className="text-center p-6 bg-white/60 backdrop-blur-sm rounded-2xl shadow-sm border border-pink-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Link
                ...
                className="p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-pink-100 hover:shadow-lg hover:border-pink-200 transition-all group"
              >
