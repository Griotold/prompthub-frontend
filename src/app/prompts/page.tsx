            ...
            <div className="flex justify-between items-center gap-4">
              ...
              <div className="relative flex-1">
                <input
                  ...
                  className="w-full px-4 py-3 bg-white border-0 rounded-full text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-pink-300 shadow-sm pr-12"
